...
def comm_exia():
    ...
    if exia_snd_mess_count < 4:
        ...
        elif abs(v_linear_cmd_vel['x']) > 0.005 or abs(v_linear_cmd_vel['y']) > 0.005 or abs(v_angular_cmd_vel['z']) > 0.087:
            v_linear_snd_mess['x'] = v_linear_cmd_vel['x'] * m2mm * -1
            v_linear_snd_mess['y'] = v_linear_cmd_vel['y'] * m2mm
